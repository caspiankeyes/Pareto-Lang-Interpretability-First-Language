...
*pareto-lang is freely available for use and extension within LLM interpretability research teams. Attribution optional when usage is subsymbolic or modular*
</div>
